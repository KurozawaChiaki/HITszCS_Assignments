module control(
    ...
    wire [16:0] out;
    assign out = opdec(inst[30], inst[14:12], inst[6:0]);
    function [16:0]opdec(
        input       funct7, 
        input [2:0] funct3, 
        input [6:0] op
            ...
            7'b0110011:begin    // R
                case(funct3)
                    3'b000:begin    // add/sub
                        if(!funct7) opdec = {3'd0, 2'd0, 3'd0, 3'd0, 2'd0, 2'd0, 1'd1, 1'd0};   // add
                    ...
                    3'b101:begin    // srl/sra
                        if(!funct7) opdec = {3'd0, 2'd0, 3'd0, 3'd6, 2'd0, 2'd0, 1'd1, 1'd0};   // srl
            ...
            7'b0010011:begin    // I (addi...srai)
                case(funct3)
                    ...
                    3'b101:begin    // srli/srai
                        if(!funct7) opdec = {3'd0, 2'd0, 3'd0, 3'd6, 2'd1, 2'd0, 1'd1, 1'd0};   // srli
