...
module control(
    ...
    begin
        case(op)
            ...
            7'b1100011:begin    // B
                case(f3)
                    3'b000: opdec = {3'd1, 2'd0, 3'd1, 3'd1, 2'd3, 2'd0, 1'd0, 1'd0};       // beq
                    3'b001: opdec = {3'd2, 2'd0, 3'd1, 3'd1, 2'd3, 2'd0, 1'd0, 1'd0};       // bne
                    3'b100: opdec = {3'd3, 2'd0, 3'd1, 3'd1, 2'd3, 2'd0, 1'd0, 1'd0};       // blt
                    3'b101: opdec = {3'd4, 2'd0, 3'd1, 3'd1, 2'd3, 2'd0, 1'd0, 1'd0};       // bge
                    default: opdec = {3'd0, 2'd0, 3'd4, 3'd5, 2'd1, 2'd2, 1'd1, 1'd0};   // lui
                endcase
            end
            7'b0110111: opdec = {3'd0, 2'd0, 3'd4, 3'd5, 2'd1, 2'd2, 1'd1, 1'd0};   // lui
            7'b1101111: opdec = {3'd0, 2'd1, 3'd2, 3'd0, 2'd3, 2'd1, 1'd1, 1'd0};   // jal
            default:    opdec = {3'd0, 2'd0, 3'd4, 3'd5, 2'd1, 2'd2, 1'd1, 1'd0};   // lui
        endcase
    end
    endfunction
